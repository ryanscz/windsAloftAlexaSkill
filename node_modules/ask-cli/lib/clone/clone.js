...
function singleSkillCloneProcess(skillId, profile, doDebug) {
    cloneSkill.getSkill(skillId, profile, doDebug, (manifest) => {
        ...
        cloneSkill.clone(skillPath, manifest, skillId, skillInfo);
