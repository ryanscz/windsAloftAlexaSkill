...
function callUpdateSkill(skillId, stage, manifest, profile, doDebug, callback) {
    let url = '/skills/' + skillId + '/stages/' + stage + '/manifest';
    let general = {
        url: url,
        method: 'PUT'
...
function callUpdateModel(skillId, stage, locale, modelSchema, profile, doDebug, callback) {
    let url = '/skills/' + skillId + '/stages/' + stage + '/interactionModel/locales/' + locale;
    let general = {
        url: url,
        method: 'PUT'
