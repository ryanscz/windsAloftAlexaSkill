...
module.exports.downloadByName = (func, dest, awsProfile, callback) => {
    ...
    downloadFromLambda(func, targetPath, zipFilePath, awsProfile, callback);
};
...
function downloadFromLambda(func, targetPath, zipFilePath, awsProfile, callback) {
    ...
    let loadSpinner = new displayUtil.Spinner('Lambda downloading...');
    loadSpinner.start();
